<div id="content">
	...
	<nav aria-label="breadcrumb" role="navigation">
		<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><a href="#"><i class="fa fa-tasks"></i> Kota</a></li>
		</ol>
	</nav>
	      ...
	      <div class="modal-body">
	        <form action="#" id="form" class="form-horizontal">
	              ...
	              <div class="form-group row">
                    <div class="col-sm-12">
    				    <label for="kota" class="col-form-label">Nama Kota/Kabupaten</label>
    				    <input type="text" name="kota" id="kota" class="form-control" placeholder="Kota" autofocus>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('kota/display')?>",
            "type": "POST"
        },
...
function tambah()
{
    ...
    $('.modal-title').text('Tambah Kota/Kabupaten'); 
}
...
function edit(id_kota)
{
    ...
    $.ajax({
        url : "<?php echo site_url('kota/edit')?>/" + id_kota,
        type: "GET",
        dataType: "JSON",
...
function simpan()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('kota/tambah')?>";
        pesan ="Simpan";
        form = '#form';
        modall = '#modal_form';
    } else {
...
function hapus(id_kota)
{
    swal({
        ...
        text:"Yakin akan menghapus kota/kab ini?",
        type: "warning",
    ...
    function(){
        $.ajax({
            url : "<?php echo site_url('kota/delete')?>/"+id_kota,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
