        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="height: 400px; overflow-y: scroll;">
            <form action="#" id="form" class="form-horizontal">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="longitute" class="col-form-label">Longitude</label>
                        <input type="text" name="longitute" id="longitute" class="form-control">
                        <small class="form-control-feedback"></small>
                    </div>
                    <div class="col-sm-6">
...
<!--<div class="modal fade" id="modal_form_detail" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="#" id="formdetail" class="form-horizontal" enctype="multipart/form-data">
                <input type="hidden" id="id_masjid" name="id_masjid">
                <div class="form-group row">
                    <div class="col-sm-12">
                        <label for="nama_masjid" class="col-form-label">Nama Masjid</label>
                        <input type="text" name="nama_masjid" id="nama_masjid" class="form-control" placeholder="Nama Masjid" disabled="">
                        <small class="form-control-feedback"></small>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label for="kota" class="col-form-label">Kota</label>
                        <input type="text" name="kota" id="kota" class="form-control" placeholder="Nama Masjid" disabled="">
                        <small class="form-control-feedback"></small>
                        </select>
                    </div>
                    <div class="col-sm-4">
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('masjid/display')?>",
            "type": "POST"
        },
