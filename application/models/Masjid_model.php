...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    var $table = 'masjid';
    var $column_order = array('nama_masjid'); 
    var $column_search = array('nama_masjid','nama_kota_kab'); 
    ...
    public function tampildatamasjid()
    {
        $this->db->select('*');
        $this->db->from('masjid a'); 
        $this->db->join('kelurahan b','b.id_kelurahan=a.id_kelurahan');
        $this->db->order_by('b.nama_kelurahan');
        $query = $this->db->get();
        return $query->result();
    }
