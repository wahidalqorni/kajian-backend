...
defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    var $table = 'kecamatan';
    var $column_order = array(null,'nama_kota_kab','nama_kecamatan'); 
    var $column_search = array('nama_kota_kab','nama_kecamatan'); 
    var $order = array('nama_kecamatan' => 'ASC');  

    private function _get_datatables_query()
    {
        $this->db->select('kecamatan.*, kota_kab.nama_kota_kab');
    ...
    public function getkodekec() {
        $q = $this->db->query("select max(right(id_kecamatan,5)) as idmax from kecamatan");
        $kd = "";
        if ($q->num_rows()>0){
